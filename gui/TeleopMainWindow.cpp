...
TeleopMainWindow::TeleopMainWindow(int argc, char** argv, QWidget* parent)
   : QMainWindow(parent),
     mArgC(argc),
     mArgV(argv),
...
void TeleopMainWindow::onVelocityCommanded(const geometry_msgs::Twist::ConstPtr& twist_msg)
{
...
void TeleopMainWindow::onOdometryMsgReceived(const nav_msgs::Odometry::ConstPtr& odometry_msg)
{
...
void TeleopMainWindow::onJoystickMsgReceived(const sensor_msgs::Joy::ConstPtr& joy_msg)
{
...
void TeleopMainWindow::updateDoubleValue(DisplayValue* widget, double value)
{
   if (widget != nullptr)
   {
...
void TeleopMainWindow::updateBooleanValue(DisplayValue* widget, bool flag)
{
   if (widget != nullptr)
   {
...
DisplayValue* TeleopMainWindow::createDisplayValueWidget(const QString&   field_name,
